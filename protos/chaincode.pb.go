...
func (m *ChaincodePath) Reset()         { *m = ChaincodePath{} }
func (m *ChaincodePath) String() string { return proto.CompactTextString(m) }
func (*ChaincodePath) ProtoMessage()    {}
...
type ChaincodeID struct {
	...
	Path *ChaincodePath `protobuf:"bytes,1,opt,name=path" json:"path,omitempty"`
...
func (m *ChaincodeID) GetPath() *ChaincodePath {
	if m != nil {
		return m.Path
	}
	return nil
