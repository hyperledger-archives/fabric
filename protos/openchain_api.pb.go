...
func _Openchain_GetBlockchainInfo_Handler(srv interface{}, ctx context.Context, codec grpc.Codec, buf []byte) (interface{}, error) {
...
func _Openchain_GetBlockByNumber_Handler(srv interface{}, ctx context.Context, codec grpc.Codec, buf []byte) (interface{}, error) {
	in := new(BlockNumber)
	if err := codec.Unmarshal(buf, in); err != nil {
		return nil, err
	}
...
func _Openchain_GetBlockCount_Handler(srv interface{}, ctx context.Context, codec grpc.Codec, buf []byte) (interface{}, error) {
	in := new(google_protobuf1.Empty)
	if err := codec.Unmarshal(buf, in); err != nil {
		return nil, err
	}
