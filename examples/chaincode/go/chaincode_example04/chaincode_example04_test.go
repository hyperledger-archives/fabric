...
import (
	...
	"github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example04"
)

// chaincode_example02's hash is used here and must be updated if the example is changed
var example02Hash = "a5389f7dfb9efae379900a41db1503fea2199fe400272b61ac5fe7bd0c6b97cf10ce3aa8dd00cd7626ce02f18accc7e5f2059dae6eb0786838042958352b89fb"
...
func TestExample04_Invoke(t *testing.T) {
	...
	stub.MockPeerChaincode(example02Hash, stubEx2)
