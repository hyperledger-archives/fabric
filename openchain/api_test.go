...
func buildTestLedger1(ledger1 *ledger.Ledger, t *testing.T) {
	...
	transaction1a := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "Contracts"}}, generateUUID(t), "NewContract", []string{"name: MyContract1, code: var x; function setX(json) {x = json.x}}"})
	...
	transaction2a := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyContract"}}, generateUUID(t), "setX", []string{"{x: \"hello\"}"})
	transaction2b := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyOtherContract"}}, generateUUID(t), "setY", []string{"{y: \"goodbuy\"}"})
...
func buildTestLedger2(ledger *ledger.Ledger, t *testing.T) {
	...
	transaction3a := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyContract"}}, generateUUID(t), "setX", []string{"{x: \"hello\"}"})
	transaction3b := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyOtherContract"}}, generateUUID(t), "setY", []string{"{y: \"goodbuy\"}"})
	transaction3c := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyImportantContract"}}, generateUUID(t), "setZ", []string{"{z: \"super\"}"})
	...
	transaction4a := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyContract"}}, generateUUID(t), "setX", []string{"{x: \"hello\"}"})
	transaction4b := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyOtherContract"}}, generateUUID(t), "setY", []string{"{y: \"goodbuy\"}"})
	transaction4c := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyImportantContract"}}, generateUUID(t), "setZ", []string{"{z: \"super\"}"})
	transaction4d := protos.NewTransaction(protos.ChaincodeID{Path: &protos.ChaincodePath{Url: "MyMEGAContract"}}, generateUUID(t), "setMEGA", []string{"{mega: \"MEGA\"}"})
