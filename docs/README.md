...
If you are new to the Hyperledger fabric, and want to learn about our position and the scope of the project, please start with the [whitepaper](https://github.com/hyperledger/hyperledger/blob/master/whitepaper.md). In addition, we encourage you to review our [glossary](glossary.md) to understand the terminology that we use throughout the website and project.
